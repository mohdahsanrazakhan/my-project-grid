  ...
  return (
    <nav className="bg-gray-100 dark:bg-slate-700 flex items-center transition-all duration-500 ease-in-out">
      <div className='flex justify-center items-center mr-auto mx-3 gap-2'>
        ...
        <h1 className="text-black dark:text-white text-xl flex justify-center items-center m-auto text-center font-medium transition-all duration-500 ease-in-out">Project Collection</h1>
      </div>
